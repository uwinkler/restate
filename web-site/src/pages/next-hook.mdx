...
The main purpose of _scoped next hoooks_ and _next hooks selector functions_ are to help you to
organise and simplify the access to your application state.
