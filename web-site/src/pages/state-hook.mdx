...
```code lines=7,10,11 src=https://stackblitz.com/edit/react-rx-state-hello-selector-render?file=index.tsx
...
```code src=https://stackblitz.com/edit/react-rx-state-hello-selector-render?file=index.tsx
...
fine grain selecotrs and therefore very efficient selectors. You should use them most of the time.
...
```code variant=warn title="Not efficient" src=https://stackblitz.com/edit/react-rx-state-hello-selector-render?file=index.tsx
const todos = useAppState(state => state.todos)
...
```code variant=ok title="Better" src=https://stackblitz.com/edit/react-rx-state-hello-selector-render?file=index.tsx
