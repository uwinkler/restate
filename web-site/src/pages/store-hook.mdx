...
Try it on [BlitzStack!](https://stackblitz.com/edit/react-rx-state-views?file=index.tsx)

```code lines=2,11-16,18-21 src=https://stackblitz.com/edit/react-rx-state-views?file=index.tsx
